                ...
                <main className="relative z-10 flex-grow flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 lg:px-16 w-full max-w-[1600px] mx-auto gap-8 lg:gap-16 text-left mt-8 md:mt-12">
                    ...
                    <div className="flex w-full lg:w-1/2 justify-center lg:justify-end relative h-[380px] sm:h-[450px] lg:h-[500px] mt-8 lg:mt-0 scale-[0.85] sm:scale-95 lg:scale-100 origin-top lg:origin-center animate-in fade-in slide-in-from-bottom-8 lg:slide-in-from-right-8 duration-1000 delay-300">
                        ...
                        <div className="relative w-full h-full max-w-sm sm:max-w-md mt-6 sm:mt-10 mx-auto">
                            {/* Main Image */}
                            <div className="absolute top-0 right-0 sm:right-0 w-52 h-64 sm:w-64 sm:h-80 rounded-3xl overflow-hidden border-4 border-white/10 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500 z-20">
                                <img
                            ...
                            <div className="absolute top-28 sm:top-32 -left-2 sm:-left-8 w-32 h-32 sm:w-48 sm:h-48 rounded-3xl overflow-hidden border-4 border-white/10 shadow-xl transform -rotate-6 hover:rotate-0 hover:z-30 transition-all duration-500 z-10 animate-[float_6s_ease-in-out_infinite]">
                                <img
                            ...
                            <div className="absolute bottom-12 sm:bottom-0 right-4 sm:right-12 w-28 h-28 sm:w-40 sm:h-40 rounded-full overflow-hidden border-4 border-white/10 shadow-lg transform rotate-12 hover:scale-105 transition-all duration-500 z-30 animate-[float_5s_ease-in-out_infinite_reverse]">
                                <img
